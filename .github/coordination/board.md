...
| F1-G | Coordination and delivery docs | GitHub Copilot | done | none | `README.md`, `CHANGELOG.md`, `AGENTS.md`, `.github/**` | `npm run build` | AI workflow docs now require reading context first, writing updates after action, and commit-push completion |
