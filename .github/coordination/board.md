...
| F1-G    | Coordination and delivery docs            | GitHub Copilot | done   | none                         | `README.md`, `CHANGELOG.md`, `AGENTS.md`, `.github/**`                                                                                                                                                                                       | `npm run build`                 | AI workflow docs now require reading all applicable instructions, always documenting completed changes, and the documented refs now exist on origin |
