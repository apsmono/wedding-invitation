...
| F1-G    | Coordination and delivery docs            | GitHub Copilot | done   | none                         | `README.md`, `CHANGELOG.md`, `AGENTS.md`, `.github/**`                                                                                                                                                                                       | `npm run build`                 | AI workflow docs now also require holding branch changes until other active AI work is finished or explicitly sequenced |
